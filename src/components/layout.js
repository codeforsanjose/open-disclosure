      ...
      <div className={layoutStyles.footerLeft}>
        <div className={layoutStyles.header}>
          <h2 className={layoutStyles.headerText}>
            Open<span className={layoutStyles.headerTextBlue}>Disclosure</span>{" "}
        ...
        <div className={layoutStyles.footerBottomContent}>
          ...
          <h6 className={layoutStyles.footerStipulation}>
            Campaign finance data provided by the City of San José Public Ethics
            Commission Public Portal for Campaign Finance and Lobbyist
